...
from models.deepseek_v4_1_flash.prefill_c1a_reuse import (
    build_tensor_specs,
    make_c1a_reuse_test,
    make_prefill_c1a_reuse,
)
...
decode_c1a_reuse = make_prefill_c1a_reuse(
    output_reduce=decode_tp_output_all_reduce,
    output_window_tokens=C.DECODE_MAX_TOKENS,
)
decode_c1a_reuse_test, l3_decode_c1a_reuse_test = make_c1a_reuse_test(
    decode_c1a_reuse, C.DECODE_MAX_TOKENS,
)


def golden_decode_c1a_reuse_case(tensors):
    apply_distributed_golden("reuse", golden_decode_c1a_reuse, tensors)
...
if __name__ == _SCRIPT_ENTRY_POINT:
    run_decode_c1a(
        "reuse", l3_decode_c1a_reuse_test, build_tensor_specs, golden_decode_c1a_reuse_case,
    )
