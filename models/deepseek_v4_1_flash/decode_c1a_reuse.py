...
def make_decode_c1a_reuse(finish=c1a_finish):
...
decode_c1a_reuse = make_decode_c1a_reuse()
decode_c1a_reuse_sharded = make_decode_c1a_reuse(c1a_finish_sharded)
...
def main():
    ...
    run_c1a("reuse", make_program, golden_decode_c1a_reuse)
