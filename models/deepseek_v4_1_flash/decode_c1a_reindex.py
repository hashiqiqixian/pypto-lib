...
def make_decode_c1a_reindex(finish=c1a_finish):
...
decode_c1a_reindex = make_decode_c1a_reindex()
decode_c1a_reindex_sharded = make_decode_c1a_reindex(c1a_finish_sharded)
