...
from models.deepseek_v4_1_flash.attention_tp import (
    OUTPUT_T_DYN, prefill_tp_output_all_reduce, prefill_tp_output_reduce_scatter,
)
from models.deepseek_v4_1_flash.config import D, TP_SIZE, AttentionMode
from models.deepseek_v4_1_flash.decode_c2a_reuse import c2a_reuse_partial, run_c2a_reuse
...
def make_prefill_attn_c2a_reuse(output_reduce=prefill_tp_output_all_reduce):
    ...
    return prefill_attn_c2a_reuse


prefill_attn_c2a_reuse = make_prefill_attn_c2a_reuse()
prefill_attn_c2a_reuse_sharded = make_prefill_attn_c2a_reuse(prefill_tp_output_reduce_scatter)


__all__ = [
    "golden_prefill_attn_c2a_reuse",
    "prefill_attn_c2a_reuse",
    "prefill_attn_c2a_reuse_sharded",
]
