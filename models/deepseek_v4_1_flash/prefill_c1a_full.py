...
def make_c1a_full_test(operator, output_window_tokens):
    ...
    return prefill_c1a_full_test, l3_prefill_c1a_full_test


prefill_c1a_full_test, l3_prefill_c1a_full_test = make_c1a_full_test(
    prefill_c1a_full, C.PREFILL_MAX_TOKENS,
)
