...
def l3_tp_ep_layer_tail(
    ...
    for r in pl.range(pld.world_size()):
        ...
        tp_ep_layer_tail(
            ...
            routed_w1_scale[r], routed_w2[r], routed_w2_scale[r], routed_w3[r],
            routed_w3_scale[r], shared_w1[r], shared_w1_scale[r], shared_w2[r],
            shared_w2_scale[r], shared_w3[r], shared_w3_scale[r],
