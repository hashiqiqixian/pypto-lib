...
def make_c1a_finish(output_reduce=c1a_reduce):
    @pl.jit.inline(auto_scope=False)
    def c1a_finish(
        query: pl.Tensor[[T_DYN, LOCAL_H * HEAD_DIM], pl.BF16],
        window_cache: pl.Tensor[[ORI_BLOCKS_DYN, 128, 1, HEAD_DIM], pl.FP8E4M3FN],
...
def make_decode_c1a_full(finish=c1a_finish):
    @pl.jit.inline(auto_scope=False)
    def decode_c1a_full(
        x: pl.Tensor[[T_DYN, D], pl.BF16],
        wq_a: pl.Tensor[[D, Q_LORA], pl.FP8E4M3FN],
...
decode_c1a_full = make_decode_c1a_full()
decode_c1a_full_sharded = make_decode_c1a_full(c1a_finish_sharded)


__all__ = [
    "golden_decode_c1a_full",
    "golden_decode_c1a_reindex",
    "golden_decode_c1a_reuse",
    "decode_c1a_full",
    "c1a_previous_epoch",
    "c1a_prepare",
    "c1a_index",
...
def main():
    ...
    run_c1a("full", make_program, golden_decode_c1a_full)
