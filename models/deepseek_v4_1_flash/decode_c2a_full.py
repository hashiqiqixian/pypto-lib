...
def make_decode_c2a_full(output_reduce=decode_tp_output_all_reduce):
    @pl.jit.inline(auto_scope=False)
    def decode_c2a_full(
...
decode_c2a_full = make_decode_c2a_full()
decode_c2a_full_sharded = make_decode_c2a_full(decode_tp_output_reduce_scatter)
