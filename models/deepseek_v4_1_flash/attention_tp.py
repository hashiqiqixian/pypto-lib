...
def make_prefill_tp_output_reduce(scatter=False):
    ...
    return prefill_tp_output_all_reduce


prefill_tp_output_all_reduce = make_prefill_tp_output_reduce()
prefill_tp_output_reduce_scatter = make_prefill_tp_output_reduce(scatter=True)
...
def make_decode_tp_output_reduce(scatter=False):
    ...
    return decode_tp_output_all_reduce
...
__all__ = [
    ...
    "decode_tp_output_reduce_scatter", "prefill_tp_output_reduce_scatter",
