...
def make_prefill_c1a_reuse(
    output_reduce=prefill_tp_output_all_reduce, output_window_tokens=C.PREFILL_MAX_TOKENS,
):
    """Build ratio-1 reuse with the selected stage communication window."""
    @pl.jit.inline(auto_scope=False)
    def prefill_c1a_reuse_impl(
        ...
        """Read published ratio-1 Top-K rows and compute packed C1A."""
    ...
    return prefill_c1a_reuse_impl


prefill_c1a_reuse = make_prefill_c1a_reuse()


def make_c1a_reuse_test(operator, output_window_tokens):
    ...
    return prefill_c1a_reuse_test, l3_prefill_c1a_reuse_test


prefill_c1a_reuse_test, l3_prefill_c1a_reuse_test = make_c1a_reuse_test(
    prefill_c1a_reuse, C.PREFILL_MAX_TOKENS,
)
