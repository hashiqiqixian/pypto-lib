...
def dspark_drafter(
    ...
    hidden_1, hidden_gather_signal = draft_layer(
        ...
        kv_cache_0, compact_query_slots[0], swa_indices_0, swa_lens_0,
    ...
    hidden_2, hidden_gather_signal = draft_layer(
        ...
        compact_query_freqs_cos, compact_query_freqs_sin,
        query_positions, compact_query_positions,
        kv_cache_1, compact_query_slots[1], swa_indices_1, swa_lens_1,
        attn_sink, wo_a, wo_b, wo_b_scale,
        hc_ffn_fn, hc_ffn_scale, hc_ffn_base, ffn_norm_w,
        gate_w, gate_bias, tid2eid, query_token_ids,
        routed_w1, routed_w1_scale, routed_w3, routed_w3_scale,
    ...
    hidden_3, hidden_gather_signal = draft_layer(
        ...
        compact_query_freqs_cos, compact_query_freqs_sin,
        query_positions, compact_query_positions,
        kv_cache_2, compact_query_slots[2], swa_indices_2, swa_lens_2,
        attn_sink, wo_a, wo_b, wo_b_scale,
        hc_ffn_fn, hc_ffn_scale, hc_ffn_base, ffn_norm_w,
        gate_w, gate_bias, tid2eid, query_token_ids,
        routed_w1, routed_w1_scale, routed_w3, routed_w3_scale,
