...
Every block entry point consumes ``[T, HC_MULT, D]`` FP32, and layer 0 feeds
it HC_MULT identical copies of the embedding row.
"""
...
def lookup_embedding_test(
    ...
    lookup_embedding(input_ids, embed_weight, x_hc_flat)
    return x_hc
