...
step before ``hc_head`` and logits are computed separately.
"""
...
from mtp import T, mtp_decoder_layer_tail
...
def l3_mtp_decode_layer(
    ...
    cmp_kv: pl.Tensor[[N_RANKS, B * SPARSE_CMP_MAX_BLOCKS, BLOCK_SIZE, 1, HEAD_DIM], pl.BF16],
    cmp_block_table: pl.Tensor[[N_RANKS, B, SPARSE_CMP_MAX_BLOCKS], pl.INT32],
    ...
    for r in pl.range(pld.world_size()):
        ...
        mtp_decode_layer(
            ...
            kv_cache[r], block_table[r], ori_slot_mapping[r],
            cmp_kv[r], cmp_block_table[r],
...
def build_tensor_specs(start_pos=DECODE_START_POS, num_tokens=T):
    ...
    ordered_names = [
        ...
        "freqs_cos", "freqs_sin", "kv_cache", "block_table", "ori_slot_mapping",
        "cmp_kv", "cmp_block_table", "attn_sink", "wo_a", "wo_b", "wo_b_scale",
...
def golden_mtp_decode_layer(tensors):
    ...
    for rank in range(N_RANKS):
        golden_attention_swa({
            ...
            "block_table": tensors["block_table"][rank],
