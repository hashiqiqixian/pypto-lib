...
"""DeepSeek-V4 MTP projection-to-logits smoke.
...
from deepseek_v4_mtp_logits import (
    VOCAB_SHARD,
...
def golden_deepseek_v4_mtp_tail(tensors):
    import torch
...
if __name__ == "__main__":
    ...
    result = run_jit(
        fn=deepseek_v4_mtp_tail,
        specs=build_tensor_specs(),
        golden_fn=golden_deepseek_v4_mtp_tail,
