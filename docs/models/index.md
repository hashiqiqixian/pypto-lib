...
| [deepseek_v4_flash_dspark](deepseek_v4_flash_dspark.md) | V4-Flash target operators plus the three-layer DSpark backbone and sequential rank-256 Markov sampler for seven-token drafting | Not supported |
